package ru.donny.burnmeter3D.engine.bullet;
...
public class BulletWorld extends BaseWorld<BulletEntity> {
	...
	public BulletWorld(final Vector3 gravity) {
		...
		collisionWorld = new btSoftRigidDynamicsWorld(dispatcher, broadphase, solver, collisionConfiguration);
	...
	public void add(final BulletEntity entity) {
		...
		if (entity.body != null) {
			if (entity.body instanceof btRigidBody)
				((btDynamicsWorld) collisionWorld).addRigidBody((btRigidBody) entity.body);
			else
